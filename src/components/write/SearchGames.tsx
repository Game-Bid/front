    ...
    >
      <div className="h-64 flex items-center gap-[10px] relative ">
        ...
        {!selectedGame ? (
          ...
          <div className="flex items-center gap-12 w-full">
            <div className="flex items-center gap-4 h-[40px] px-16 rounded-max bg-bgGrayDepth3  ">
              <span className="text-fgPrimary text-[14px] font-semibold cursor-pointer leading-[1.4] tracking-[-0.28px]">
                {selectedGame.name}
            ...
            <input
              className="flex-1 bg-transparent placeholder:text-fgGrayPlaceholder text-[16px]"
      ...
      {focused && (
        <>
          ...
          <div className="h-fit text-fgGrayPlaceholder text-normal flex py-4 ">
            <div
